...
export default function PrivacyTab() {
    ...
    return (<>
        ...
        <RadioOption checked={settings.explicit_content_filter === 2}
                     onClick={() => dispatch(setSettings({explicit_content_filter: 2}))}
        ...
        <RadioOption checked={settings.explicit_content_filter === 1}
                     onClick={() => dispatch(setSettings({explicit_content_filter: 1}))}
        ...
        <RadioOption checked={settings.explicit_content_filter === 0}
                     onClick={() => dispatch(setSettings({explicit_content_filter: 0}))}
        ...
        <CheckboxOption checked={settings.view_nsfw_guilds}
                        onClick={() => dispatch(setSettings({view_nsfw_guilds: !settings.view_nsfw_guilds}))}
        ...
        <CheckboxOption checked={settings.view_nsfw_commands}
                        onClick={() => dispatch(setSettings({view_nsfw_commands: !settings.view_nsfw_commands}))}
